...
public class JMCh20Exercises<E>
{
    ...
    public ListNode<E> removeFirst( ListNode<E> head )
    {
        ...
        return head2;  //TODO fix return value
    }
    ...
    public int sizeFor( ListNode<E> head )
    {
        ...
        return count;  //TODO fix return value
    }
    ...
    {
        ListNode<E> newTemp = null;
        ListNode<E> newTemp2 = null;
        for (ListNode<E> temp = head; temp != null; temp = temp.getNext())
        {
            
            if (temp.getValue().equals(head.getValue()))
            {
                newTemp = new ListNode<E>(temp.getValue(), null);
            }
            else
            {
                newTemp2 = new ListNode<E>(temp.getValue(), newTemp);
                newTemp = newTemp2;
            }
    ...
    public ListNode<String> concatenateStrings( ListNode<String> head )
    {
        ...
        {
            temp.setValue(previous.getValue() + temp.getValue());
            previous = temp;
        }
    ...
    public ListNode<String> insertInOrder( ListNode<String> head, String s )
    {
        ...
        for (ListNode<String> temp = head; temp != null; temp = temp.getNext()) 
        {
            String current = temp.getValue();
            String next = null;
            if (temp.getNext() != null)
            {
            ...
            {
               ListNode<String> add = new ListNode<String>(s, null);
               temp.setNext(add);
               break;
            }
            ...
            {
                ListNode<String> add = new ListNode<String>(s, temp);
                head = add;
                break;
            }
            else if (current.compareTo(s) < 0 && next.compareTo(s) > 0)
            {
                ListNode<String> add = new ListNode<String>(s,temp.getNext());
                temp.setNext(add);
                break;
            }
        }
    ...
    public static void sort( ListNode<String> head )
    {
        ...
        {
          ListNode<String> minNode = firstNode;
          for (ListNode<String> tempNode = firstNode.getNext(); tempNode != null; tempNode = tempNode.getNext())
          {
            String string = tempNode.getValue();
            if (string.compareTo(minNode.getValue()) < 0)
            {
                minNode = tempNode;
            }
          }
          String minValue = minNode.getValue();
          minNode.setValue(firstNode.getValue());
          firstNode.setValue(minValue);
    ...
    public static ListNode2<Integer> removeMax( ListNode2<Integer> head )
    {
        ...
        int max = 0;
        for (ListNode2<Integer> temp = head; temp != null; temp = temp.getNext())
        {
